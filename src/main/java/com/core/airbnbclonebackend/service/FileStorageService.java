...
import com.core.airbnbclonebackend.repository.FileDescriptorRepository;
    ...
    public ResponseEntity<?> uploadFileToS3(String pathName, List<MultipartFile> multipartFiles) {
        ...
        try{
            ...
            for (MultipartFile file:multipartFiles) {
                ...
                String tempPathName = pathName + (fileDescriptor.getId() + "." + fileDescriptor.getExtension()) ;

                File covertedFile = convertMultipartFileToFile(file, fileDescriptor.getId());
                PutObjectRequest putObjectRequest =
                        new PutObjectRequest(bucketName, tempPathName, covertedFile);
